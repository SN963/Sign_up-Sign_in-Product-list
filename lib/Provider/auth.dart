...
//if the condition is acheived successfully return the token
  ...
  Future<void> _authenticate(
    ...
    //sign up
    final url =
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyA8o5EA2sVC4kuPgDH6UJ1E8cckVJhhoys";
  ...
  Future<void> _signupauthenticate(
    ...
    print(_userId);
    final url =
        "https://fruits-vegetables-basket-19e0d-default-rtdb.firebaseio.com/UserData/$_userId.json";
    print("1");
    print(_userId);
    try {
      final response = await http.post(Uri.parse(url),
      ...
      final responseData = json.decode(response.body);
      //responseData[AuthUtils.authTokenKey];
      //Httpexception to handle the errors that can happen and give me details about it
      if (responseData['error'] != null) {
        print('x');
